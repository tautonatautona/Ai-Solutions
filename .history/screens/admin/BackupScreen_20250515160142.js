  ...
  const handleBackup = async () => {
    try {
      ...
      await setDoc(lastBackupDocRef, {
        ...
        size: backupData.usersCount + backupData.chatsCount,
      });

      // Log backup success
      await logBackupOperation('success', `Backed up ${backupData.usersCount} users and ${backupData.chatsCount} chats.`);
